...
public class LeafSheepModel extends DefaultedEntityGeoModel<LeafSheepEntity> {

    public LeafSheepModel() {
        super(new ResourceLocation(Faunify.MODID, "leafsheep"), true);
    }

    @Override
    public ResourceLocation getAnimationResource(LeafSheepEntity object) {
        return new ResourceLocation(Faunify.MODID, "animations/leafsheep.animation.json");
    }
